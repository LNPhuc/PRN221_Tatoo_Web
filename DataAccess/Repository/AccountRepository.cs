...
public class AccountRepository : GenericRepository<Account>, IAccountRepository
{
    ...
    {
        return _context.Set<Account>().Include(c => c.Customers).Include(c => c.Studios)
    ...
    {
        var account =
            await _context.Accounts.FirstOrDefaultAsync(a => a.Email.Equals(Email) && a.Password.Equals(Pass));
        return account;
    }
